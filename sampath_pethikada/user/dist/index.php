...
<html lang="en">
  ...
  <body>
    ...
    $sql2=$conn->query("SELECT sum(male) as total FROM total_population");
  ...
  echo $row['total'];
              ...
              <center><br><br><br><br><p class="card-description"><code>අද දිනය:<label><span id="datetime"></span><script>var dt = new Date();
                  document.getElementById("datetime").innerHTML=dt.toLocaleString();</script> </label></code></p>
                    <footer class="btn-gradient-dark">ආයුබෝවන්. <cite title="Source Title">ඔබට සුබ දවසක්!</cite></footer></center> 
            </div>
