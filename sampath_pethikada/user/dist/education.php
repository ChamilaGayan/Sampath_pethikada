...
$q3 =$conn->query("SELECT * from school_information WHERE year='$year_update'");
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(national_schools) as total FROM school_information");
...
<th><?php
    $sql1=$conn->query("SELECT sum(provincial_council_schools) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(oneab) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(onec) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(two) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(three) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(private_schools) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(sinhala) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tamil) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(english) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(no_students) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(no_teachers) as total FROM school_information");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from teachers_edu_level WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(graduate) as total FROM teachers_edu_level");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $a= $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(training) as total FROM teachers_edu_level");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $b=$row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(untrained) as total FROM teachers_edu_level");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $c=$row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(other) as total FROM teachers_edu_level");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $d=$row['total'];
      }
...
$q3 =$conn->query("SELECT * from teachers_medium_instruction WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(sinhala) as total FROM teachers_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tamil) as total FROM teachers_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(sinhala_english) as total FROM teachers_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(english_tamil) as total FROM teachers_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from students_medium_instruction WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(sinhala_female) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(sinhala_male) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tamil_female) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tamil_male) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(english_female) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(english_male) as total FROM students_medium_instruction");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from students_grades_studied WHERE year='$year_update'");
    if($q3 !== false && $q3->num_rows > 0){
    while($row=$q3->fetch_assoc()){
      $id=$row['id'];
      $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(one_five) as total FROM students_grades_studied");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(six_ten) as total FROM students_grades_studied");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(ol) as total FROM students_grades_studied");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(al) as total FROM students_grades_studied");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(special_education_units) as total FROM students_grades_studied");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from pirivena WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(no_students) as total FROM pirivena");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(no_teachers) as total FROM pirivena");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from preschool WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(no_students) as total FROM preschool");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from vocational_center WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(no_students) as total FROM vocational_center");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(no_teachers) as total FROM vocational_center");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from library WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $gnd=$row['gnda'];
...
$q3 =$conn->query("SELECT * from other_educational_institutions WHERE year='$year_update'");
    if($q3 !== false && $q3->num_rows > 0){
    while($row=$q3->fetch_assoc()){
      $id=$row['id'];
      $gnd=$row['gnda'];
...
$q3 =$conn->query("SELECT * from passed_examination WHERE year='$year_update'");
    if($q3 !== false && $q3->num_rows > 0){
    while($row=$q3->fetch_assoc()){
      $id=$row['id'];
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(gradefive_exame_appearances) as total FROM passed_examination");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(cutoffmarks_applicants) as total FROM passed_examination");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(ol_appearances) as total FROM passed_examination");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(al_qualified) as total FROM passed_examination");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(al_appearances) as total FROM passed_examination");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from admission_universities WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
?>
  ...
  <th><?php
    $sql1=$conn->query("SELECT sum(twothousand_nineteen_female) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(twothousand_nineteen_male) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(twothousand_twenty_female) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(twothousand_twenty_male) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(twothousand_twentyone_female) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(twothousand_twentyone_male) as total FROM admission_universities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from special_educational_institutions WHERE year='$year_update'");
    if($q3 !== false && $q3->num_rows > 0){
    while($row=$q3->fetch_assoc()){
      $id=$row['id'];
...
<th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(government) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(nogov_student) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(semi_government) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(nosemi_student) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(`private`) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(nopriv_student) as total FROM special_educational_institutions");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
