...
$q1 =$conn->query("SELECT * from source_light WHERE year='$year_update'");
...
<th><?php
    $sql1=$conn->query("SELECT sum(electricity) as total FROM source_light");
...
<th><?php
    $sql1=$conn->query("SELECT sum(lamp_oil) as total FROM source_light");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(solar_power) as total FROM source_light");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(other_power) as total FROM source_light");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(no_electricity) as total FROM source_light");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q2 =$conn->query("SELECT * from materials_used_houses WHERE year='$year_update'");
...
<th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(durable_house) as total FROM materials_used_houses");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(non_durable_house) as total FROM materials_used_houses");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from housing_unit WHERE year='$year_update'");
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(individual_houses) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(pair_houses) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(shanty_houses) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(appropriate_houses) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(apartments) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(other_houses) as total FROM housing_unit");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q4 =$conn->query("SELECT * from material_used_roof WHERE year='$year_update'");
...
?>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(durable_roof) as total FROM material_used_roof");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(non_durable_roof) as total FROM material_used_roof");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q5 =$conn->query("SELECT * from source_drinking_water WHERE year='$year_update'");
...
?>
  ...
  <th><?php
    $sql1=$conn->query("SELECT sum(well) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(main_pipe_water) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(rural_water_projects) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tube_well) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(bottled_water) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(river) as total FROM source_drinking_water");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q6 =$conn->query("SELECT * from toilet_facilities WHERE year='$year_update'");
...
?>
 ...
 <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(has_a_toilet) as total FROM toilet_facilities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(has_a_toilet_shared) as total FROM toilet_facilities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(public_toilet) as total FROM toilet_facilities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(not_using_toilet) as total FROM toilet_facilities");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q7 =$conn->query("SELECT * from house_ownership  WHERE year='$year_update'");
...
<th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(freelancer) as total FROM house_ownership");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tax) as total FROM house_ownership");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(rent) as total FROM house_ownership");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(other_units) as total FROM house_ownership");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q1 =$conn->query("SELECT * from tot_hous_units WHERE year='$year_update'");
if($q1 !== false && $q1->num_rows > 0){
while($row=$q1->fetch_assoc()){
...
<th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(tot_house_units) as total FROM tot_hous_units");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tot_families) as total FROM tot_hous_units");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
