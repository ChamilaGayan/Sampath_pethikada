...
$q3 =$conn->query("SELECT * from emp_major_sectors WHERE year='$year_update'");
...
?>
                ...
                <tr>
                  ...
                  <th></th>
                  <th><?php
    $sql1=$conn->query("SELECT sum(agriculture) as total FROM emp_major_sectors");
...
<th><?php
    $sql1=$conn->query("SELECT sum(industrial) as total FROM emp_major_sectors");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(services) as total FROM emp_major_sectors");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(tot_services_division) as total FROM emp_major_sectors");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q3 =$conn->query("SELECT * from unemployment_rate WHERE year='$year_update'");
  if($q3 !== false && $q3->num_rows > 0){
  while($row=$q3->fetch_assoc()){
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(services_total_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(services_total_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(government_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(government_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(semi_government_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(semi_government_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(private_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(private_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(self_employment_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(self_employment_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(unemployment_female) as total FROM unemployment_rate");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(unemployment_male) as total FROM unemployment_rate");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
$q3 =$conn->query("SELECT * from unskilled_abroad_emp WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_me_nt) as total FROM unskilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_me_nt) as total FROM unskilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_korea_nt) as total FROM unskilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_korea_nt) as total FROM unskilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_europe_nt) as total FROM unskilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_europe_nt) as total FROM unskilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_other_country_nt) as total FROM unskilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_other_country_nt) as total FROM unskilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
$q3 =$conn->query("SELECT * from skilled_abroad_emp WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_me_skilled) as total FROM skilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_me_skilled) as total FROM skilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_korea_skilled) as total FROM skilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_korea_skilled) as total FROM skilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_europe_skilled) as total FROM skilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_europe_skilled) as total FROM skilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_other_country_skilled) as total FROM skilled_abroad_emp");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_other_country_skilled) as total FROM skilled_abroad_emp");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
$q3 =$conn->query("SELECT * from unemployment WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_eighteen_twentyfive) as total FROM unemployment");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_eighteen_twentyfive) as total FROM unemployment");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_twentysix_forty) as total FROM unemployment");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_twentysix_forty) as total FROM unemployment");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_fortyone_sixty) as total FROM unemployment");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_fortyone_sixty) as total FROM unemployment");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $row['total'];
