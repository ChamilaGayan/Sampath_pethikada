...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
  $q3 =$conn->query("SELECT * from registered_trading_companies WHERE year='$year_update'");
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
  $q3 =$conn->query("SELECT * from registered_manufacturing_industry WHERE year='$year_update'");
  if($q3 !== false && $q3->num_rows > 0){
  while($row=$q3->fetch_assoc()){
    $id=$row['id'];
    $mining=$row['mining'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from weekly_fair WHERE year='$year_update'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>  
<?php 
 $q3 =$conn->query("SELECT * from large_scale_factories WHERE year='$year_update'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
 $q3 =$conn->query("SELECT * from products_endemic WHERE year='$year_update'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
   $factory=$row['factory'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>   
<?php 
 $q3 =$conn->query("SELECT * from fishing_industry WHERE year='$year_update'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
