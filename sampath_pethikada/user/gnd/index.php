...
<html lang="en">
  ...
  <body>
              ...
              <div class="col-md-4 stretch-card grid-margin" style="height:200px;">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  ...
                  <img src="../../assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    ...
                    <?php
    $sql1=$conn->query("SELECT sum(female) as total FROM total_population WHERE userid='$uid' AND gnda='$gnd'");
    ...
    $sql2=$conn->query("SELECT sum(male) as total FROM total_population WHERE userid='$uid' AND gnda='$gnd'");
  ...
  echo $row['total'];
              ...
              <center><br><br><br><br><p class="card-description"><code>අද දිනය:<label><span id="datetime"></span><script>var dt = new Date();
                  document.getElementById("datetime").innerHTML=dt.toLocaleString();</script> </label></code></p>
                    <footer class="btn-gradient-info">ආයුබෝවන්. <cite title="Source Title">ඔබට සුබ දවසක්!</cite></footer></center> 
