...
$q3 =$conn->query("SELECT * from religious_centers WHERE year='$year_update' AND ds='$ds'");
...
$q3 =$conn->query("SELECT * from buddhist_temples WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id2=$row['id'];
  $name=$row['name'];
...
$q3 =$conn->query("SELECT * from hindu_religious_shrines WHERE year='$year_update' AND ds='$ds'");
                      if($q3 !== false && $q3->num_rows > 0){
                      while($row=$q3->fetch_assoc()){
                        $id3=$row['id'];
                        $name=$row['name'];
...
$q3 =$conn->query("SELECT * from catholic_churches WHERE year='$year_update' AND ds='$ds'");
                      if($q3 !== false && $q3->num_rows > 0){
                      while($row=$q3->fetch_assoc()){
                        $id4=$row['id'];
                        $name=$row['name'];
...
$q3 =$conn->query("SELECT * from islamic_religious_centers WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id5=$row['id'];
  $name=$row['name'];
...
$q3 =$conn->query("SELECT * from religious_places_renovated WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id6=$row['id'];
  $name=$row['name'];
...
$q3 =$conn->query("SELECT * from cultural_arts_institute WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $name=$row['name'];
...
$q3 =$conn->query("SELECT * from specific_artists WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $name=$row['name'];
