...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
  $q3 =$conn->query("SELECT * from registerd_hotels WHERE year='$year_update' AND ds='$ds'");
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
 $q3 =$conn->query("SELECT * from special_locations WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
