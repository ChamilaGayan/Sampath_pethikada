...
$q3 =$conn->query("SELECT * from rural_service_centers WHERE year='$year_update' AND ds='$ds'");
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from gov_hospitals WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from quarantine_staff WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>  
<?php 
$q3 =$conn->query("SELECT * from ayurvedic WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
 $q3 =$conn->query("SELECT * from rural_private_medical WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>   
<?php 
$q3 =$conn->query("SELECT * from covid_patient WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
 $q3 =$conn->query("SELECT * from live_births WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from maternal_death WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
    $id=$row['id'];
    $medical_officer=$row['medical_officer'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
  $q3 =$conn->query("SELECT * from rabies WHERE year='$year_update' AND ds='$ds'");
  if($q3 !== false && $q3->num_rows > 0){
  while($row=$q3->fetch_assoc()){
    $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
  $q3 =$conn->query("SELECT * from dengue WHERE year='$year_update' AND ds='$ds'");
  if($q3 !== false && $q3->num_rows > 0){
  while($row=$q3->fetch_assoc()){
    $id=$row['id'];
    $malaria=$row['malaria'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from patient_reg_clinics WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
    $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from social_diseases WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
    $id=$row['id'];
