...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from permit_vehicle WHERE year='$year_update' AND ds='$ds'");
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
   $q3 =$conn->query("SELECT * from new_vehicle WHERE year='$year_update' AND ds='$ds'");
   if($q3 !== false && $q3->num_rows > 0){
   while($row=$q3->fetch_assoc()){
     $id=$row['id'];
     $car=$row['car'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
$q3 =$conn->query("SELECT * from road_grade WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>  
<?php 
 $q3 =$conn->query("SELECT * from post_office WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
