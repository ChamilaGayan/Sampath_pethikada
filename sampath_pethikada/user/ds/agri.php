...
$q3 =$conn->query("SELECT * from extent_cultivated_land WHERE year='$year_update' AND ds='$ds'");
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from yield_sown WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from animal_statistics WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $cow=$row['cow'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>  
<?php 
$q3 =$conn->query("SELECT * from milk_egg WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $no_cow=$row['no_cow'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
 $q3 =$conn->query("SELECT * from land_ownership WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>   
<?php 
$q3 =$conn->query("SELECT * from land_ownership_lots WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php
$q3 =$conn->query("SELECT * from land_ownership_mud WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $three_quarters_familiy=$row['three_quarters_familiy'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from agricultural_land WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $total_land=$row['total_land'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from cultivation_paddy WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $crops=$row['crops'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from cultivation_vegetables WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
   $crops=$row['crops'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from cultivation_fruit WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
  $fruit=$row['fruit'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from cultivation_spices WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
   $crops=$row['crops'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
$q3 =$conn->query("SELECT * from organic_fertilizer WHERE year='$year_update' AND ds='$ds'");
if($q3 !== false && $q3->num_rows > 0){
while($row=$q3->fetch_assoc()){
  $id=$row['id'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <tbody>
<?php 
 $q3 =$conn->query("SELECT * from agricultural_reservoirs WHERE year='$year_update' AND ds='$ds'");
 if($q3 !== false && $q3->num_rows > 0){
 while($row=$q3->fetch_assoc()){
   $id=$row['id'];
