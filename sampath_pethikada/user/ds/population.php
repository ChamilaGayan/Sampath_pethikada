...
<?php
//total_population
$q1 =$conn->query("SELECT * from total_population WHERE year='$year_update' AND ds='$ds'");
...
<th><?php
    $sql1=$conn->query("SELECT sum(male) as total FROM total_population WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $m1= $row['total'];
      }
...
$q2 =$conn->query("SELECT * from adult_population_education WHERE year='$year_update' AND ds='$ds'");
...
?>
                ...
                <tr>
                  ...
                  <th></th>
                  <th><?php
    $sql1=$conn->query("SELECT sum(female_notedu) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_notedu) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1= $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_one_five) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_one_five) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_six_ten) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_six_ten) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3= $row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_ol) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f4=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_ol) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m4=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_al) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f5=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_al) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m5=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_degree) as total FROM adult_population_education WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f6=$row['total'];
      }
    ...
    $sql1=$conn->query("SELECT sum(male_degree) as total FROM adult_population_education WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m6=$row['total'];
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              ...
              <?php 
//population_religion
$q3 =$conn->query("SELECT * from population_religion WHERE year='$year_update' AND ds='$ds'");
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_buddhist) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_buddhist) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
    }
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_tamil) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_tamil) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_muslim) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_muslim) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_rome) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f4=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_rome) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m4=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_cristian) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f5=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_cristian) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m5=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_other) as total FROM population_religion WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f6=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_other) as total FROM population_religion WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m6=$row['total'];
...
<?php
//population_ds
$q4 =$conn->query("SELECT * from population_ds WHERE year='$year_update' AND ds='$ds'");
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_town) as total FROM population_ds WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_town) as total FROM population_ds WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
    ...
    ?></th>
    <th><?php
    $sql1=$conn->query("SELECT sum(female_rural) as total FROM population_ds WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_rural) as total FROM population_ds WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];     
    ...
    ?></th>
    <th><?php
    $sql1=$conn->query("SELECT sum(female_estates) as total FROM population_ds WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_estates) as total FROM population_ds WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(land_density) as total FROM population_ds WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
<th><?php
    $sql1=$conn->query("SELECT sum(population_density) as total FROM population_ds WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $row['total'];
      }
...
$q5 =$conn->query("SELECT * from population_electoral_roll WHERE year='$year_update' AND ds='$ds'");
...
?>
                ...
                <tr>
                  ...
                  <th></th>
                  <th><?php
    $sql1=$conn->query("SELECT sum(female_vote) as total FROM population_electoral_roll WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_vote) as total FROM population_electoral_roll WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
...
$q6 =$conn->query("SELECT * from population_ethnicity WHERE year='$year_update' AND ds='$ds'");
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_sinhala) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_sinhala) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_sltamil) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_sltamil) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_intamil) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_intamil) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_yonaka) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f4=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_yonaka) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m4=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_brg) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f5=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_brg) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m5=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_otherpo) as total FROM population_ethnicity WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f6=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_otherpo) as total FROM population_ethnicity WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m6=$row['total'];
...
<?php 
//population_age
$q7 =$conn->query("SELECT * from population_age WHERE year='$year_update' AND ds='$ds'");
...
<th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_zero_five) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1= $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_zero_five) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_six_fourteen) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_six_fourteen) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_fifteen_eighteen) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_fifteen_eighteen) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_nineteen_thirtyfive) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f4=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_nineteen_thirtyfive) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m4=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_thirtysix_sixty) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f5=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_thirtysix_sixty) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m5=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_sixty) as total FROM population_age WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f6=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_sixty) as total FROM population_age WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m6=$row['total'];
...
<?php 
//abroad_population
$q8 =$conn->query("SELECT * from abroad_population WHERE year='$year_update' AND ds='$ds'");
...
?>
                ...
                <th></th>
                <th><?php
    $sql1=$conn->query("SELECT sum(female_job) as total FROM abroad_population WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_job) as total FROM abroad_population WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_edu) as total FROM abroad_population WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f2=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_edu) as total FROM abroad_population WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m2=$row['total'];
...
<th><?php
    $sql1=$conn->query("SELECT sum(female_otherfor) as total FROM abroad_population WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f3=$row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_otherfor) as total FROM abroad_population WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m3=$row['total'];
...
<?php 
//retired_population
$q9 =$conn->query("SELECT * from retired_population WHERE year='$year_update' AND ds='$ds'");
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(female_retirees) as total FROM retired_population WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $f1= $row['total'];
    ...
    $sql1=$conn->query("SELECT sum(male_retirees) as total FROM retired_population WHERE ds='$ds'");
    if($sql1 !== false && $sql1->num_rows > 0){
    while($row=$sql1->fetch_assoc()){
      echo $m1=$row['total'];
...
<?php
//dependency_rate
$q10 =$conn->query("SELECT * from dependency_rate WHERE year='$year_update' AND ds='$ds'");
...
<tr>
  ...
  <th></th>
  <th><?php
    $sql1=$conn->query("SELECT sum(child) as total FROM dependency_rate WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $a=$row['total'];
      }
    ...
    <th><?php
    $sql1=$conn->query("SELECT sum(aging) as total FROM dependency_rate WHERE ds='$ds'");
      if($sql1 !== false && $sql1->num_rows > 0){
      while($row=$sql1->fetch_assoc()){
        echo $b=$row['total'];
      }
