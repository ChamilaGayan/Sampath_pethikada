...
?>
                ...
                <tr>
                  ...
                  <td><?php echo $year2; ?></td>
		              <td><?php echo $female_notedur; ?></td>
                  <td><?php echo $male_notedur; ?></td>
                  <td><?php echo $female_one_fiver; ?></td>
                  <td><?php echo $male_one_fiver; ?></td>
                  <td><?php echo $female_six_tenr; ?></td>
                  <td><?php echo $male_six_tenr; ?></td>
                  <td><?php echo $female_olr; ?></td>
                  <td><?php echo $male_olr; ?></td>
                  <td><?php echo $female_alr; ?></td>
                  <td><?php echo $male_alr; ?></td>
                  <td><?php echo $female_degreer; ?></td>
                  <td><?php echo $male_degreer; ?></td>
                  <td><?php echo $female_notedur+$female_one_fiver+$female_six_tenr+$female_olr+$female_alr+$female_degreer ; ?></td>
                  <td><?php echo $male_notedur+$male_one_fiver+$male_six_tenr+$male_olr+$male_alr+$male_degreer; ?></td>
                </tr>
...
<div class="col-lg-12">
            ...
            <table id="example" class="display">
              <thead>
                <tr>
                  <th rowspan="2">ප්‍රා.ලේ</th>
                  <th rowspan="2">වර්ෂය</th>
                  <th colspan="2">බෞද්ධ </th>
                  <th colspan="2">හින්දු </th>
                  <th colspan="2">ඉස්ලාම් </th>
                  <th colspan="2">රෝමානු කතෝලික </th>
                  <th colspan="2">ක්‍රිස්තියානි</th>
                  <th colspan="2">වෙනත් </th>
  ...
  $ds3=$row['ds'];
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $female_buddhistr; ?></td>
                  <td><?php echo $male_buddhistr; ?></td>
                  <td><?php echo $female_tamilr; ?></td>
                  <td><?php echo $male_tamilr; ?></td>
                  <td><?php echo $female_muslimr; ?></td>
                  <td><?php echo $male_muslimr; ?></td>
                  <td><?php echo $female_romer; ?></td>
                  <td><?php echo $male_romer; ?></td>
                  <td><?php echo $female_cristianr; ?></td>
                  <td><?php echo $male_cristianr; ?></td>
                  <td><?php echo $female_otherr; ?></td>
                  <td><?php echo $male_otherr; ?></td>
                  <td><?php echo $female_buddhistr+$female_tamilr+$female_muslimr+$female_romer+$female_cristianr+$female_otherr ;?></td>
                  <td><?php echo $male_buddhistr+$male_tamilr+$male_muslimr+$male_romer+$male_cristianr+$male_otherr; ?></td>
                </tr>
                </tbody>
...
?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo "ස්ත්‍රී : $female_townr  පුරුෂ : $male_townr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_ruralr  පුරුෂ : $male_ruralr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_estatesr  පුරුෂ : $male_estatesr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : "; echo $female_townr+$female_ruralr+$female_estatesr; echo "&nbsp;&nbsp;&nbsp;පුරුෂ : "; echo $male_townr+$male_ruralr+$male_estatesr; ?></td>
...
?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo "ස්ත්‍රී : $female_voter  පුරුෂ : $male_voter"; ?></td>
                  <td><?php echo $female_voter+$male_voter+$female_estatesr; ?></td>
                </tr>
                </tbody>
                <?php }} ?>
              </table>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $year6; ?></td>
		              <td><?php echo "ස්ත්‍රී : $female_sinhalar  පුරුෂ : $male_sinhalar"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_sltamilr  පුරුෂ : $male_sltamilr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_intamilr  පුරුෂ : $male_intamilr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_yonakar  පුරුෂ : $male_yonakar"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_brgr  පුරුෂ : $male_brgr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_otherpor  පුරුෂ : $male_otherpor"; ?></td>
                  <td><?php echo "ස්ත්‍රී : "; echo $female_sinhalar+$female_sltamilr+$female_intamilr+$female_yonakar+$female_brgr+$female_otherpor ; echo "&nbsp;&nbsp;&nbsp;පුරුෂ : "; echo $male_sinhalar+$male_sltamilr+$male_intamilr+$male_yonakar+$male_brgr+$male_otherpor; ?></td>
                </tr>
                </tbody>
                <?php }} ?>
              </table>
...
?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo "ස්ත්‍රී : $female_zero_fiver  පුරුෂ : $male_zero_fiver"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_six_fourteenr  පුරුෂ : $male_six_fourteenr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_fifteen_eighteenr  පුරුෂ : $male_fifteen_eighteenr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_nineteen_thirtyfiver  පුරුෂ : $male_nineteen_thirtyfiver"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_thirtysix_sixtyr  පුරුෂ : $male_thirtysix_sixtyr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_sixtyr  පුරුෂ : $male_sixtyr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : "; echo $female_zero_fiver+$female_six_fourteenr+$female_fifteen_eighteenr+$female_nineteen_thirtyfiver+$female_thirtysix_sixtyr+$female_sixtyr ; echo "&nbsp;&nbsp;&nbsp;පුරුෂ : "; echo $male_zero_fiver+$male_six_fourteenr+$male_fifteen_eighteenr+$male_nineteen_thirtyfiver+$male_thirtysix_sixtyr+$male_sixtyr; ?></td>
                </tr>
                </tbody>
                <?php }} ?>
              </table>
...
?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo "ස්ත්‍රී : $female_jobr  පුරුෂ : $male_jobr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_edur  පුරුෂ : $male_edur"; ?></td>
                  <td><?php echo "ස්ත්‍රී : $female_otherforr  පුරුෂ : $male_otherforr"; ?></td>
                  <td><?php echo "ස්ත්‍රී : "; echo $female_jobr+$female_edur+$female_otherforr ; echo "&nbsp;&nbsp;&nbsp;පුරුෂ : "; echo $male_jobr+$male_edur+$male_otherforr; ?></td>
                </tr>
                </tbody>
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $year9; ?></td>
		              <td><?php echo "ස්ත්‍රී : $female_retireesr  පුරුෂ : $male_retireesr"; ?></td>
